    ...
    <div className="flex h-[calc(100vh-88px)]">
      ...
      <aside className="w-56 flex-shrink-0 border-r border-[#c0c0c0] bg-white flex flex-col z-10">
        <div className="px-3 py-2 border-b border-[#c0c0c0]" style={{ backgroundColor: "#6261c0" }}>
          ...
          <p className="text-white/70 text-[10px] mt-0.5">Select a day to see your route</p>
        </div>
        ...
        <div className="flex border-b border-[#c0c0c0]">
          {DAY_CODES.map((d, i) => (
            <button key={d} onClick={() => setSelDay(d)}
              className="flex-1 py-2 text-[11px] font-bold border-r border-[#c0c0c0] last:border-r-0 transition-colors"
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-1.5">
          {dayMeetings.length === 0
            ? <p className="text-[11px] text-gray-400 text-center py-6">No classes on {DAY_LABELS[DAY_CODES.indexOf(selDay)]}</p>
            : dayMeetings.map(({ course, meeting }, i) => (
              <div key={i} className="flex gap-2 p-2 border rounded text-[11px]"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-gray-400 flex items-center gap-0.5 text-[10px]">
        ...
        {routeLatLngs.length > 1 && (
          <div className="p-2 border-t border-[#c0c0c0] text-[10px] text-gray-500 flex items-center gap-1.5">
